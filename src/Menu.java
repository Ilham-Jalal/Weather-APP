...
public class Menu {
    ...
    LocalDate eventDate;
            ...
            do{
                ...
                System.out.println("|------------<   9: Rechercher l'historique d'une ville    >-----------|");
                System.out.println("|======================================================================|");
                ...
                switch (choice) {
                    case 1:
                        ...
                        System.out.print("-----<Entrez la vitesse du vent actuelle :");
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        System.out.println("****** tout les histoires des villes ****** ");
                        for (CityHistory cityHistory : DatabaaseManager.DisplayCityHistory()) {
                            System.out.println(cityHistory);
                        }
                        break;
                    case 9:
                        System.out.println("-----<Entrez Identifiant de la ville associée :");
                        cityId = new Scanner(System.in).nextInt();
                        DatabaaseManager.searchCityHistory(cityId);
                        break;
                    case 10:
